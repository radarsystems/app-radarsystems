...
export default function ModalSmall({ minWidth, maxWidth, children, width, visible, buttonSave = true, cancel, onClick, next, callback, Pending, close = function () { } }) {
    ...
    return (
        <>
            <div className="modal-small" id={`modal-${modalId}`} style={{ display: visibleModal == true ? 'flex' : 'none' }}>
